      ...
      <div class="mt-6 flex flex-column gap-1">
          ...
          <div class="mt-6 flex flex-column gap-2">
            ...
            <FontPicker
              ...
              presets={[
                ...
                { value: 'Pretendard JP Variable', label: 'Pretendard' },
              ]}
            />
            <FontPicker
              ...
              presets={[
                ...
                { value: 'RIDIBatang', label: 'RIDIBatang' },
                { value: 'KimjungchulMyungjo', label: 'KJC Serif' },
              ]}
            />
            <FontPicker
        ...
        <section>
          ...
          <div class="mt-6 flex flex-column gap-2">
            ...
            />
            <NumberInputWithSlider
              label={s('settings.container_max_width')}
              value={settings.containerMaxWidth ?? 720}
              min={480}
              max={1440}
              step={40}
              onChange={(v) => setSettings('containerMaxWidth', v)}
            />
            <NumberInputWithSlider
              label={s('settings.letter_spacing')}
            ...
            />
            <SettingRow label={s('settings.text_align')}>
              <select
                value={settings.textAlign ?? 'justify'}
                onChange={(e) =>
                  setSettings(
                    'textAlign',
                    e.currentTarget.value as 'left' | 'justify',
                  )
                }
              >
                <option value="justify">
                  {s('settings.text_align_justify')}
                </option>
                <option value="left">{s('settings.text_align_left')}</option>
              </select>
            </SettingRow>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="mt-6 flex flex-column gap-2">
            <SettingRow label={s('settings.spellcheck')}>
              <input
                type="checkbox"
                checked={settings.spellcheck ?? true}
                onChange={(e) =>
                  setSettings('spellcheck', e.currentTarget.checked)
                }
              />
            </SettingRow>
